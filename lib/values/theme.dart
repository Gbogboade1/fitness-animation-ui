...
class AppBaseThemeValues {
  static final lightTheme = BaseTheme(
    ...
    textColor: ColorStyle(
      c100: const Color.fromRGBO(134, 134, 134, 1),
      c600: Colors.black,
    ),
    iconColor: ColorStyle(
      c100: const Color.fromRGBO(134, 134, 134, 1),
    ),
    ...
    primary: ColorStyle(
      ...
      c400: const Color.fromRGBO(255, 188, 169, 1),
      c600: const Color.fromRGBO(255, 116, 23, 1),
    ),
    ...
    primaryColor: const Color.fromRGBO(255, 116, 23, 1),
  );
  ...
  static final darkTheme = BaseTheme(
    ...
    danger: ColorStyle(),
    neutral: ColorStyle(
      c700: const Color.fromRGBO(161, 96, 255, 1),
    ),
